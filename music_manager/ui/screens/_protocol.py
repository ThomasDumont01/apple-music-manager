...
class MenuScreenProto(Protocol):
    ...
    _recs_store: RecommendationsStore | None
    _paths: Paths | None
    _requests_path: str
    _playlists_dir: str
    ...
    _dup_result: dict
    _dup_pl_groups: list[dict]
    _dup_pl_idx: int
    _dup_pl_cursor: int
    _dup_pl_actions: list[str]
    _dup_phase: str
    ...
    # Recommendations
    _recommend_mode: str
    _recommend_count: int
    _recommend_running: bool
    _recommend_result: object
